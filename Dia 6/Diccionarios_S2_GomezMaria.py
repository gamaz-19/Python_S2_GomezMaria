...
# ##########################
# Diccionarios
#Un Diccionario  es una colección de elementos , donde cada elementos insertado tiene una llave úntica, 
...
#Desarrollado por Maria Alejandra Gómez : C.C-1005234916